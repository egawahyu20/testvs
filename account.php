					...
					<form method="POST" action="function/edit_customer.php">
						...
						<h3>Edit My Account...</h3>
							<table>
								...
								<tr>
									<td></td><td><input type="submit" name="edit" value="Save Changes" class="btn btn-success">&nbsp;<a href="home.php"><input type="button" name="cancel" value="Cancel" class="btn btn-warning"></a><a href="home.php">&nbsp;<input type="button" name="delete" value="delete" class="btn btn-danger"></a></td>
								</tr>
							</table>	
						</center>
					</form>

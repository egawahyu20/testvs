...
<div id="container">
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php">Komputer/pc</a></li>
			<li>|</li>
			<li><a href="football.php" >Laptop</a></li>
			<li>|</li>
			<li><a href="running.php" class="active" style="color:#111;">Aksesoris</a></li>
		</ul>
	</div>
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Token.com Inc. 2015</p>
		</div>
